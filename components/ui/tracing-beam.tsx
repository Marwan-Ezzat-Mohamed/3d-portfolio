...
export const TracingBeam = ({
  ...
  const y1 = useSpring(
    useTransform(scrollYProgress, [0, 0.8], [50, svgHeight - velo * 800]),
    {
      stiffness: 300,
      damping: 150,
    },
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 1], [50, svgHeight - velo * 800]),
    {
      stiffness: 300,
      damping: 150,
    },
  ...
  return (
    <motion.div className="relative h-max">
      ...
      <div ref={contentRef} className="max-container relative h-max">
        {children}
      </div>
    </motion.div>
  )
